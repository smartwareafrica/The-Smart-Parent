...
public class AddRemindersActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentReminderUri == null) {
            ...
            setTitleColor(Color.blue(Color.WHITE));

            // Invalidate the options menu, i.e. "Delete" menu option can be hidden. It doesn't make sense to delete a reminder that hasn't been created yet.
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(AddRemindersActivity.this);
                    return true;
                }
    ...
    private void showDeleteConfirmationDialog() {
        ...
        builder.setNegativeButton(R.string.cancel, (dialog, id) -> {
            // User clicked the "Cancel" button, so dismiss the dialog and continue editing the reminder.
            if (dialog != null) {
                dialog.dismiss();
            }
        });
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            // Pass in null for the selection and selection args because the Current reminder Uri
